...
public abstract class GLES30Wrapper extends GLES20Wrapper {
    ...
    /**
     * Implementation constructor - DO NOT USE!!! TODO - protect/hide this
     * constructor
     * 
     * @param platform
    ...
    public InterfaceBlock[] getUniformBlocks(ProgramInfo info) {
        ...
        for (int i = 0; i < uniformBlock.length; i++) {
            ...
            if (blockInfo.get(0) > 0) {
                ...
                glGetActiveUniformBlockiv(program, i, GLES30.GL_UNIFORM_BLOCK_REFERENCED_BY_VERTEX_SHADER, blockInfo);
                blockInfo.position(InterfaceBlock.FRAGMENT_REFERENCE_INDEX);
                glGetActiveUniformBlockiv(program, i, GLES30.GL_UNIFORM_BLOCK_REFERENCED_BY_FRAGMENT_SHADER, blockInfo);
                // Block name is fetched using blockIndex so we know the blockIndex to be
                // correct.
        ...
        switch (type) {
            ...
            case UNIFORM:
                ...
                return new NamedShaderVariable(type,
                        getVariableName(nameBuffer, params[NamedShaderVariable.NAME_LENGTH_OFFSET]), index, params, 0);
            case UNIFORM_BLOCK:
                params = new int[10];
                glGetActiveUniform(program, index, params, NamedShaderVariable.NAME_LENGTH_OFFSET, params,
                        NamedShaderVariable.SIZE_OFFSET, params, NamedShaderVariable.TYPE_OFFSET, nameBuffer);
    ...
    /**
     * This method works with buffer object, add method with element buffer if
     * needed.
     * 
     * @param mode
     * @param start
     ...
     * @param count
     * @param type
     * @param offset Specifies a byte offset into the buffer bound to
    ...
    /**
     * Abstraction for glSamplerParameteri( GLuint sampler, GLenum pname, GLint
     * param);
     * 
     * @param sampler
     * @param pname
    ...
    /**
     * Abstraction for glUniformBlockBinding(GLuint program, GLuint
    ...
    /**
     * Abstraction for glBindBufferRange( GLenumtarget, GLuintindex, GLuintbuffer,
    ...
    /**
     * Abstraction for GLuint glGetUniformBlockIndex( GLuint program, const GLchar
     * *uniformBlockName);
     * 
     * @param program
    ...
    /**
     * Astraction for glGetActiveUniformBlockiv(GLuint program, GLuint
    ...
    /**
     * Abstraction for void glGetActiveUniformBlockName( GLuint program, GLuint
    ...
    /**
     * Abstraction for void glGetActiveUniformsiv( GLuint program, GLsizei
    ...
    /**
     * Abstraction for void *glMapBufferRange( GLenum target, GLintptr offset,
    ...
    /**
     * Abstraction for void glFlushMappedBufferRange(GLenum target, GLintptr offset,
     * GLsizeiptr length);
     * 
     * @param target
     * @param offset
