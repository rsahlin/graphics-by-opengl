 ...
 * Use this to get basic support for gson and to register type adapters for generic classes.
 *
 * @param <T> The Node class that shall be serialized
 */
public abstract class AbstractNucleusDeserializerImpl<T> implements NucleusDeserializer<T> {
